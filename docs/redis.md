...
分布式缓存主要解决的是单机缓存的容量受服务器限制并且无法保存通用信息的问题。因为，本地缓存只在 当前服务里有效，比如如果你部署了两个相同的服务，他们两者之间的缓存数据是无法共同的。
...
![正常缓存处理流程](redis/cache-process.c27b9c06.png)
...
你可以自己本机安装 redis 或者通过 redis 官网提供的[在线 redis 环境open in new window](https://try.redis.io/)。

![try-redis](redis/try-redis.7ac61820.png)
...
![redis list](redis/redis-list.e79ad4dd.png)
...
![img](redis/redis事件处理器.66ac2f3d.png)

### Redis 没有使用多线程？为什么不使用多线程？

虽然说 Redis 是单线程模型，但是，实际上，**Redis 在 4.0 之后的版本中就已经加入了对多线程的支持。**

![redis4.0 more thread](redis/redis4.0-more-thread.6f35d9c0.png)
...
1. [Redis 6.0 新特性-多线程连环 13 问！open in new window](https://mp.weixin.qq.com/s/FZu3acwK6zrCBZQ_3HoUgw)
...
![redis过期字典](redis/redis过期时间.96c57f41.png)
...
- [Redis 的 AOF 方式 #783open in new window](https://github.com/Snailclimb/JavaGuide/issues/783)
- [Redis AOF 重写描述不准确 #1439open in new window](https://github.com/Snailclimb/JavaGuide/issues/1439)
...
![img](redis/image-20210807145107290.png)
...
![redis事务](redis/redis事务.7f91c775.png)
...
![redis roll back](redis/redis-rollBack.89c51afa.png)
...
![缓存穿透情况](redis/6358650a9bf742838441d636430c90b9.png)
...
![img](redis/加入布隆过滤器后的缓存处理流程.79596186.png)
...
- 通俗易懂的 Redis 数据结构基础教程：[https://juejin.im/post/5b53ee7e5188251aaa2d2e16open in new window](https://juejin.im/post/5b53ee7e5188251aaa2d2e16)
