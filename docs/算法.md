...
server {
    ...
    location /test {
        alias /sxapp/sxappopt/app/dist;
        index index.html index.htm;
    }
    
    location /frontend {
        alias /sxapp/sxappopt/app/dist/frontend;
        index index.html index.htm;
    }
    
    location /backstage {
        alias /sxapp/sxappopt/app/dist/backstage;
        index index.html index.htm;
    }
}
```
...
```
nginx -s reload -c /sxapp/sxappopt/conf/nginx/nginx.conf
```



```
3k/mdkmxlFbKQ96DQh8gSEehfNByXbSkjsO7ewTDFpZUjMcf5lhM0jT1tQBh1jKP9sDuESurMrshDC3+2u8TOg==
```
